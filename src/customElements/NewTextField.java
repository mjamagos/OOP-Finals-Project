...
public class NewTextField extends JTextField {
    ...
    public void setText(String t) {
        // If t is null/empty, set placeholder mode
        if (t == null || t.isEmpty()) {
            super.setText(placeholder);      // keep placeholder text in the document for visual
            showingPlaceholder = true;
            setForeground(placeholderColor);
        } else {
            // set actual text and mark that we are not showing the placeholder
            showingPlaceholder = false;
            super.setText(t);
            setForeground(Color.BLACK);
        }
